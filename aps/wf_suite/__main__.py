...
from aps.wf_suite.launcher.main_launcher import MainLauncher
...
if __name__ == "__main__":
    def show_help(error=False):
        ...
        if error:
            ...
            print("=============================================================\n")
        print("To launch a script:       python -m aps.wf_suite <script id> <options>\n")
        print("To show help of a script: python -m aps.wf_suite <script id> --h\n")
        print("To show this help:        python -m aps.wf_suite --h\n")
