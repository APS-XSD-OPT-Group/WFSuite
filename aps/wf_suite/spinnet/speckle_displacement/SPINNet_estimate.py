...
from aps.wf_suite.spinnet.speckle_displacement.DS_network import MODULE_PATH
# Insert the absolute path to the directory containing the DS_network module to the system path
sys.path.insert(0, MODULE_PATH)

from aps.wf_suite.spinnet.speckle_displacement.DS_network import SpeckleDisplacementNet
